...
def run_part3() -> dict:
    ...
    data_dir = generate_demo_gtsrb(ROOT)
    ...
    model_path = ARTIFACT_DIR / "demo_model.keras"
    ...
    print(
        f"  - Demo accuracy={accuracy:.4f} | Correct={correct}/{total} "
    ...
    if results["part3"]["status"] == "completed":
        lines.extend(
            [
                ...
                f"- Demo accuracy: {results['part3']['accuracy']:.4f}",
